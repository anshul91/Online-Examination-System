...
if (isset($_REQUEST['save']) && $_REQUEST['save'] == 'Save' && $_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_REQUEST['id'])) {
    if ($empFxn->addEmployee()) {
        header("location:" . SITE_URL . "?page=employee_employeeDesc");
        exit;
    }
} else if (isset($_REQUEST['save']) == 'Save' && isset($_REQUEST['id'])) {
    
    $empFxn->updateEmployee($userId);
    header("location:" . SITE_URL . "?page=employee_employeeDesc&id=".$empFxn->encode($userId));
    exit;
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            $empFxn->unsetMessage();
            ?>
            <h3 class="page-header">Employee Data</h3>
            <div class="panel panel-default">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="personal">
                                ...
                                <table border="0" cellspacing="15" cellpadding="5">
                                    <tr>                             
                                        <td><label>First name</label><input type="text" name="emp_f_name" placeholder ="Enter first name" class="form-control " value="<?php if (isset($_REQUEST['emp_f_name'])) {
                ...
                echo '';
                                        ...
                                        <td><label>Middle name</label><input type="text" name="emp_m_name" placeholder ="Enter middle name" class="form-control"  value="<?php if (isset($_REQUEST['emp_m_name'])) {
                ...
                echo '';
                                        ...
                                        <td><label>Last name</label><input type="text" name="emp_l_name" placeholder ="Enter Last" class="form-control" value='<?php if (isset($_REQUEST['emp_f_name'])) {
                ...
                echo '';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="emp_father_name" placeholder ="Enter Father's Name" class="form-control" value='<?php if (isset($_REQUEST['emp_father_name'])) {
                ...
                echo '';
                                        ...
                                        <td><label>DOB</label>
                                            <input type="date" name="emp_dob" placeholder="dd-mm-yyyy" class="form-control" value='<?php if (isset($_REQUEST['emp_dob'])) {
                ...
                echo '';
                                        ...
                                        <td><label>Gender</label><br>
                                            <input type="radio" name="emp_gender" value="M" class=" form-group"<?php if (isset($_REQUEST['emp_gender']) && $_REQUEST['emp_gender'] == 'M') {
                echo "checked";
            } else if (isset($empData[0]) && $empData[0]->gender == 'M') {
                echo "checked";
            } ?>/>Male
                                            <input type="radio" name="emp_gender" value="F"style="padding:20px 0px;" <?php if (isset($_REQUEST['emp_gender']) && $_REQUEST['emp_gender'] == 'F') {
                echo "checked";
                ...
                echo "checked";
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="radio" name="emp_marital" value="single" class=" form-group"<?php if (isset($_REQUEST['emp_marital']) && $_REQUEST['emp_marital'] == 'single') {
                echo "checked";
...
<?php } ?>
                                        ...
                                        <td>
                                            ...
                                            <select name="emp_employee_type" class="form-control" onchange="employeeType(this.value);" id="emp_employee_type">
