...
//    echo "<center>".$examFxn->decode($_REQUEST['id']);die;
    ...
    $stuPkgSelected = json_decode($studentFxn->getStudentOptPaper(array("stu_id" => $userId)));
}
?>
<style>
    td,th{
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            ?>
            <h3 class="page-header">My Details</h3>
                ...
                <form name="student_frm" id="student_frm" enctype="multipart/form-data" method="post" novalidate="novalidate">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#contact" data-toggle="tab">Contact Details</a>
                            </li>
                            <li class=""><a href="#education" data-toggle="tab">Education Details</a>
                            </li>
                            <li class=""><a href="#group" data-toggle="tab">Course Details</a>
                            </li>
                        </ul>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (isset($stuData[0])){ $center = json_decode($masterFxn->getCenterList(array("id"=>$stuData[0]->study_center_id)));}?>
                                            <input type='text' name='stu_study_center_id' value=" <?php if (isset($_REQUEST['stu_study_center_id'])) echo $_REQUEST['stu_study_center_id'];else if (isset($stuData[0])){echo $center[0]->center_name;} ?>" class="form-control">
                                            ...
                                            <select name="sel_pkg_id[]" class="form-control" multiple="true" size="6">
                                                ...
                                                for ($i = 0; $i < count($exmPackageList); $i++) {
                                                    if ($j >= count(@$stuPkgSelected))
                                                        $j = 0;
                                                    ?>
                                                    <option value="<?php echo $exmPackageList[$i]->id ?>" <?php if (isset($_REQUEST['sel_pkg_id']) && $_REQUEST['sel_pkg_id'] == $exmPackageList[$i]) echo "selected";else if (isset($stuPkgSelected[$j]) && count(@$stuPkgSelected) > 0 && $stuPkgSelected[$j]->id == $exmPackageList[$i]->id) {
                                                    echo "selected";
                                                    $j++;
