...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php if($commonObj->canUpdate($_REQUEST['page'])){?><a href="<?php echo SITE_URL."?page=course_courseDesc";?>"class="btn btn-success" style="margin-bottom: 5px;" name="add_course">Add Course +</a>
            <?php }?>
        </div>
        </div>
        <!-- /.col-lg-12 -->
                            ...
                            <tbody>
                                ...
                                foreach ($courseData as $k => $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo SITE_URL . "?page=course_courseDesc&id=" . $courseFxn->encode($v->id); ?>">Alter</a>
                                        </td>
